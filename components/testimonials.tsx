      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="flex flex-wrap md:flex-nowrap items-center pt-32 pb-12 md:pt-40 md:pb-20">
          ...
          <div className="md:w-2/5 text-left">
            <h1 className="text-4xl md:text-5xl font-bold leading-tighter tracking-tighter mb-4">Alcance o futuro desenvolvendo hoje!</h1>
            <div>
              <p className="text-lg text-gray-600 mb-8">Nossa equipe está aguardando ansiosamente seu contato para juntos iniciarmos o seu projeto.</p>
